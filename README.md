...
- **Data & Computing:** PySpark, pandas, Spark MLlib
- **Databases:** MariaDB, Kùzu, RocksDict
- **Visualization:** ggplot2
- **Tools:** Git, GitHub, VS Code, Linux

## Featured Work

- 🧬 **Epilepsy Meta-Analysis Replication** — Replicated a figure from a published epilepsy genetics study using R and ggplot2
- 🧬 **Hetionet Biomedical Network Analysis** — Analyzed biomedical relationships between compounds, genes, and diseases using PySpark
- 🔬 **Breast Cancer Classification** — Compared machine learning models for classifying breast tumors using PySpark and Spark MLlib
- 🗄️ **Social Media Platform Database** — Designed a relational database using SQL and MariaDB
